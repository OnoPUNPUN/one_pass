...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/defult_avatar.svg
  SvgGenImage get defultAvatar => const SvgGenImage('assets/images/defult_avatar.svg');

  /// File path: assets/images/no_results.svg
  SvgGenImage get noResults => const SvgGenImage('assets/images/no_results.svg');

  /// File path: assets/images/profile_avatar.jpg
  AssetGenImage get profileAvatar => const AssetGenImage('assets/images/profile_avatar.jpg');

  /// List of all assets
  List<dynamic> get values => [defultAvatar, noResults, profileAvatar];
}
